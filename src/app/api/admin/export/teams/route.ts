...
export async function GET() {
  ...
  const [league, teams] = await Promise.all([
    db.league.findFirst({
      select: {
        ...
        logoData: true,
        logoType: true,
        welcomeEmailMessage: true,
        welcomeEmailSubjectTemplate: true,
        welcomeEmailBodyTemplate: true,
  ...
  const leagueRow = {
    ...
    welcomeEmailMessage: league?.welcomeEmailMessage ?? null,
    welcomeEmailSubjectTemplate: league?.welcomeEmailSubjectTemplate ?? null,
    welcomeEmailBodyTemplate: league?.welcomeEmailBodyTemplate ?? null,
