    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "During Attendance, the Meet Coordinator can edit attendance for every team, and other coaches can edit attendance for their own team. In Draft, the Meet Coordinator can still edit attendance across the meet, and coaches with coordinator-granted edit access can edit attendance for their own team. During Check-in, other team coaches need edit access from the Meet Coordinator before they can enter scratches for their own team, while the Meet Coordinator can manage scratches for any team and handle replacement matches [Meet > Attendance, Meet > Scratches, Meet > Coordinator].",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "In Check-in, stop rebuilding the whole meet. Team coaches with coordinator-granted edit access use Scratches for their own team, while the Meet Coordinator and admins handle cross-team adjustments, replacement bouts, and the final path to publish [Meet > Scratches, Meet > Publish].",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Check-in is the live meet-day adjustment phase. The default tab is Scratches. Team coaches with coordinator-granted edit access can record scratches for their own team, while the Meet Coordinator and admins can record scratches for any team and handle replacement matches and other cross-team changes without the lock. Volunteers is hidden in this phase, and the published wall-chart and scoring-sheet tabs are not shown until publishing [Meet > Scratches].",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "In Draft, the home-team coordinator can update attendance across the meet, and coaches with granted edit access can update attendance for their own team [Meet > Attendance, Meet > Coordinator].",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "If a Draft attendance save is rejected, check the user's role and scope. The Meet Coordinator can update attendance across the meet, and coaches with granted edit access can update attendance for their own team. Other coaches may still be limited from Draft attendance changes [Meet > Attendance, Meet > Coordinator].",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Use [Admin > Head Coaches] to assign the single head coach for each team so every team has a primary contact and someone responsible for coordination.",
          "The Head Coaches tab lets you pick from existing coach accounts, create a new coach account already locked to that team, or import head coaches in bulk from a CSV, XLS, or XLSX file [Admin > Head Coaches].",
          "The head coach remains a team designation and also serves as Meet Coordinator for home meets, including deciding which assistant coaches have edit access [Admin > Head Coaches, Meets].",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "For head coaches specifically, use [Admin > Head Coaches] instead of the general Users table. That tab keeps one head coach per team, lets you create a new coach account for a specific team, and supports bulk import with an auto-downloaded results file that includes usernames, emails, and temporary passwords for new accounts [Admin > Head Coaches].",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Grant edit access controls who can help with Draft editing. It also controls which coaches may enter their own team's scratches during Check-in and which coaches may edit their own team's attendance in Draft. It does not affect Attendance-phase own-team attendance edits, and it does not change the Meet Coordinator's broader Attendance and Check-in access [Meet > Attendance, Meet > Scratches].",
        ],
      },
      {
        title: "Lock workflow",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "If a team says it cannot complete Check-in, remember that team coaches do not need the meet lock for scratch entry, but they do need coordinator-granted edit access and must be working on their own team. The Meet Coordinator and admins handle replacement matches and cross-team changes during Check-in without the lock [Meet > Scratches].",
