...
export const HELP_PAGES: HelpPage[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Edit your roster before you start creating meets to ensure the pairing engine has accurate weights, birthdates, experience levels, skills, and active status for every wrestler on your team [Rosters > Manage].",
          "The first row in the roster grid adds new wrestlers. Fill it out and click Add to create a pending new entry [Rosters > Manage > Add].",
          "Click any cell in the grid to start editing that value, then tab or move around to fill in the rest of the row.",
          "The roster table highlights changed rows with a light blue tint and shows inactive entries with a strike-through, making it easy to spot what still needs saving and which athletes are temporarily inactive. Use the \"Show Inactive\" toggle at the top of the roster page to reveal those inactivated records when you need to edit or audit them, and flip the active/inactive selector in each row to keep someone in history for long absences instead of deleting them [Rosters > Manage].",
          "Use the delete button only when the record should be removed completely. Rely on the active flag for temporary changes so you can bring the wrestler back without losing their history [Rosters > Manage].",
          "Importing and exporting use the CSV template: Last, First, Birthdate, Weight, ExperienceYears, Skill. Export will download a copy of the current roster and import will update the roster (useful if you use a different tool to edit your roster). Always verify the column order and headers so the system maps each value correctly [Rosters > Import].",
          "**Always click Save or Cancel** after editing so the highlighted rows clear; until you commit or discard, the system keeps your edits visually flagged to remind you the roster has pending changes [Rosters > Manage].",
        ],
      },
      {
