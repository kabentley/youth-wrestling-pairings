    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Import/export uses the CSV template: Last, First, Birthdate, Weight, ExperienceYears, Skill. Export downloads the current roster; import updates the roster from that template [Rosters > Import]. Always confirm column order and headers.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "After you click Done in the attendance dialog, auto pairings run and the meet plan updates. Review and adjust as needed [Meet > Pairings, Meet > Mat Assignments].",
        ],
      },
      {
        title: "Meets page",
        paragraphs: [
          ...
          "Use View to open, Edit for edit mode, and Delete to remove a meet. The list also shows last edit info [Meets].",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Run Auto Pairings clears current bouts and generates a new set, so confirm before running it if you want to keep manual edits [Meet > Pairings].",
