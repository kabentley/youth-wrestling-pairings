...
export default function ParentAttendancePanel({ embedded = false }: ParentAttendancePanelProps) {
  ...
  return (
    <section className={`attendance-panel${embedded ? " embedded" : ""}`}>
      <style>{`
        ...
        .attendance-panel.embedded .attendance-card {
          box-shadow: none;
          background: #fbfdff;
        }
        .page-message {
        ...
        {embedded ? (
                      ...
                      <div className="meet-header">
                        ...
                        {formatMeetCheckinWindow(meet.checkinStartAt, meet.checkinDurationMinutes) && (
                          <div className="meet-meta">
                            <strong>Checkin time:</strong> {formatMeetCheckinWindow(meet.checkinStartAt, meet.checkinDurationMinutes)}
                          </div>
                        )}
          ...
          <>
            ...
            {loaded && meets.length === 0 && !msg && (
              <div className="attendance-card">No upcoming meets.</div>
            )}
            {meets.length > 0 && (
              <section className="meet-grid">
                {meets.map((meet) => {
